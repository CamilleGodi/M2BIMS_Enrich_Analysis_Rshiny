...
#'
do_gsea_go_terms <- function(reactive_annotated_data, organism_db, universe, ontology, p_value_cutoff, p_adj_cutoff, q_value_cutoff) {
  
  gsea_ids <- prepare_gsea(reactive_annotated_data)
  
  gsea_go <- load_gsea_go(gsea_ids, universe, organism_db)
...
do_gsea_kegg <- function(reactive_annotated_data, organism_db, universe, kegg_organism_code, p_value_cutoff, p_adj_cutoff, q_value_cutoff) {
  ...
  gsea_kegg <- load_gsea_kegg(gene_list = gsea_ids,
